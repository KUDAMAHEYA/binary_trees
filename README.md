...
Your files 14-binary_tree_balance.c, 103-binary_tree_rotate_left.c and 104-binary_tree_rotate_right.c will be
...
The last property must be recursively true for all nodes in Binary Tree37. Heap - Insert
#advanced
